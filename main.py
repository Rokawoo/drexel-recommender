...
def subtractCounter():
    ...
    if session["b"] == 1:
        ...
        sortedList = newDF.index.values.tolist()
    if session["b"] == 0:
        newDF = newDF.sort_values(by="Price", ascending=False)
        sortedList = newDF.index.values.tolist()
    nameDF = newDF.loc[:, "Name"]
    priceDF = newDF.loc[:, "Price"]
    linkDF = newDF.loc[:, "WebLinks"]
    if n > 0:
        # name output
        name1 = str(nameDF.loc[sortedList[n]])
        name2 = str(nameDF.loc[sortedList[n + 1]])
        name3 = str(nameDF.loc[sortedList[n + 2]])
        name4 = str(nameDF.loc[sortedList[n + 3]])
        name5 = str(nameDF.loc[sortedList[n + 4]])
        name6 = str(nameDF.loc[sortedList[n + 5]])
        name7 = str(nameDF.loc[sortedList[n + 6]])
        name8 = str(nameDF.loc[sortedList[n + 7]])
        name9 = str(nameDF.loc[sortedList[n + 8]])
        name10 = str(nameDF.loc[sortedList[n + 9]])

        # price output
        price1 = str(priceDF.loc[sortedList[n]])
        price2 = str(priceDF.loc[sortedList[n + 1]])
        price3 = str(priceDF.loc[sortedList[n + 2]])
        price4 = str(priceDF.loc[sortedList[n + 3]])
        price5 = str(priceDF.loc[sortedList[n + 4]])
        price6 = str(priceDF.loc[sortedList[n + 5]])
        price7 = str(priceDF.loc[sortedList[n + 6]])
        price8 = str(priceDF.loc[sortedList[n + 7]])
        price9 = str(priceDF.loc[sortedList[n + 8]])
        price10 = str(priceDF.loc[sortedList[n + 9]])

        # link output
        link1 = str(linkDF.loc[sortedList[n]])
        link2 = str(linkDF.loc[sortedList[n + 1]])
        link3 = str(linkDF.loc[sortedList[n + 2]])
        link4 = str(linkDF.loc[sortedList[n + 3]])
        link5 = str(linkDF.loc[sortedList[n + 4]])
        link6 = str(linkDF.loc[sortedList[n + 5]])
        link7 = str(linkDF.loc[sortedList[n + 6]])
        link8 = str(linkDF.loc[sortedList[n + 7]])
        link9 = str(linkDF.loc[sortedList[n + 8]])
        link10 = str(linkDF.loc[sortedList[n + 9]])
...
@app.route("/sortAscending", methods=["POST"])
def sortAscending():
    session["b"] = 1
    return render_template("writingToolsPage.html")

@app.route("/sortDescending", methods=["POST"])
def sortDescending():
    session["b"] = 0
    return render_template("writingToolsPage.html")
